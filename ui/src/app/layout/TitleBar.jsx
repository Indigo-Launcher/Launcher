...
export default function TitleBar() {
  const handleMinimize = () => electronClient.minimize();
  const handleMaximize = () => electronClient.maximize();
  const handleClose = () => electronClient.close();
    ...
    >
      ...
      <div className="flex items-center gap-2" style={{ WebkitAppRegion: 'no-drag' }}>
        <div className="w-5 h-5 rounded overflow-hidden shrink-0">
          <img src="/Icons/logo.png" alt="Indigo Launcher" className="w-full h-full object-cover" />
        </div>
